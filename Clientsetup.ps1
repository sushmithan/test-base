...
c:/users/splunkforwarder-6.6.2-4b804538c686-x64-release.msi AGREETOLICENSE=Yes RECEIVING_INDEXER=$splunkfqdn:9997 "C:\Windows\Logs" SERVICESTARTTYPE=auto /qn
